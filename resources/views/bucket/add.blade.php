			...
			<div class="content-wrapper">
				...
				<section class="content">
					...
					<div class="container-fluid">
                        <form id="form" method="POST" name="bucket_form" action="{{ route('bucket.store') }}">
                            @csrf
                            <div class="card">
                                <div class="card-body">								
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3 @error('name') has-error @enderror">
                                                ...
                                                <input type="text" name="name" id="name" required class="form-control" placeholder="Bucket Name">	
                                                @error('name')
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3 @error('unit') has-error @enderror">
                                                ...
                                                <input type="text" name="unit" id="unit" required class="form-control" placeholder="Bucket Unit">	
                                                @error('unit')
