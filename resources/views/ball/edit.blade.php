			...
			<div class="content-wrapper">
				...
				<section class="content">
					...
					<div class="container-fluid">
                        <form id="form" method="POST" name="ball_form" action="{{ route('ball.update', $ball->id) }}">
                            @csrf
                            @method('put')
                            <div class="card">
                                <div class="card-body">								
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3 @error('name') has-error @enderror">
                                                ...
                                                <input type="text" name="name" id="name" required class="form-control" placeholder="Ball Name" value="{{ old('name', $ball->name) }}">	
                                                @error('name')
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3 @error('unit') has-error @enderror">
                                                ...
                                                <input type="text" name="unit" id="unit" required class="form-control" placeholder="Ball Unit" value="{{ old('unit', $ball->unit) }}">	
                                                @error('unit')
